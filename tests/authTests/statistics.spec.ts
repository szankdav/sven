...
test('/statistics/author page should display the correct text for an unauthorized guest', async ({
  page,
}) => {
...
test('/statistics/author/*number* page should display the correct text for an unauthorized guest', async ({
  page,
}) => {
